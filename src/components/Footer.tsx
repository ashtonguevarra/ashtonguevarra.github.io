      ...
      <div className="max-w-5xl mx-auto px-6 py-12 flex flex-col md:flex-row items-center justify-between gap-6">
        <div className="flex flex-col items-center md:items-start gap-1">
          <p className="text-sm text-secondary">
            &copy; {currentYear} Ashton Guevarra. All rights reserved.
          </p>
        ...
        <div className="flex items-center gap-4">
          <a
            href="https://github.com/ashtonguevarra"
            target="_blank"
          ...
          <a
            href="https://linkedin.com/in/ashtonguevarra"
            target="_blank"
            rel="noopener noreferrer"
            className="text-secondary hover:text-foreground transition-colors cursor-pointer"
          ...
          <a
            href="https://x.com/ashtonguevarra"
            target="_blank"
            rel="noopener noreferrer"
            className="text-secondary hover:text-foreground transition-colors cursor-pointer"
